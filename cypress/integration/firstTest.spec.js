...
describe('My first test suite', () => {
    ...
    it('Test Fill Inline form', () => {
        cy.get('input[placeholder="Jane Doe"]').type('Husnul Hotimah')
        cy.get('[placeholder="Email"][type="text"]').type('husnulhotimah9c@gmail.com')
    ...
    it('Test Fill Using the Grid', () => {
        cy.get('#inputEmail1').type('husnulhotimah9c@gmail.com')
    ...
    it('Test Fill Basic form', () => {
        cy.get('#exampleInputEmail1').type('husnulhotimah9c@gmail.com')
    ...
    it('Test Fill Form without labels', () => {
        cy.get('[placeholder="Recipients"]').type('Husnul Hotimah')
    ...
    it('Fill Block form', () => {
        cy.get('#inputFirstName').type('Husnul')
        cy.get('#inputLastName').type('Hotimah')
        cy.get('#inputEmail').type('husnulhotimah9c@gmail.com')
        cy.get('#inputWebsite').type('www.tugaspplhusnul.com')
        cy.get('[status="primary"][type="submit"]')
        cy.contains('Submit')
    });

    it('Fill Horizontal form', () => {
        cy.get('#inputEmail3').type('husnulhotimah9c@gmail.com')
